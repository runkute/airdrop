...
_DEFAULT_COST = (5.0, 15.0)  # fallback to gpt-4o pricing
...
class OpenAIProvider(BaseAIProvider):
    ...
    def calculate_cost(
        ...
        # Normalise model name to key (e.g. "gpt-4o-2024-08-06" -> "gpt-4o")
        key = model
    ...
    async def generate(
        ...
        try:
            ...
            log.error("openai_api_error", error=str(exc), model=resolved_model)
            raise
    ...
    async def is_available(self) -> bool:
        try:
            ...
            log.warning("openai_availability_check_failed", error=str(exc))
            return False
